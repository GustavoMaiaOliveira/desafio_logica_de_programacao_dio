...
function calculateXP(
    ...
    const XPtotal = XPforEnemy * dificultLevel * multiplicator
    return XPtotal
}

const result1 = calculateXP(45, 40)
console.log("Você ganhou " + result1 + " XP!")
const result2 = calculateXP(41, 38)
console.log("Você ganhou " + result2 + " XP!")
const result3 = calculateXP(15, 20)
console.log("Você ganhou " + result3 + " XP!")